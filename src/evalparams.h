...
extern int PSQ_TABLE_QUEEN[NSQUARES];
extern int PSQ_TABLE_KING_MG[NSQUARES];
extern int PSQ_TABLE_KING_EG[NSQUARES];
extern int KNIGHT_MATERIAL_VALUE;
extern int BISHOP_MATERIAL_VALUE;
extern int ROOK_MATERIAL_VALUE;
extern int QUEEN_MATERIAL_VALUE;
