...
extern int TWO_KING_ATTACKERS_WEIGHT;
extern int THREE_KING_ATTACKERS_WEIGHT;
extern int FOUR_KING_ATTACKERS_WEIGHT;
extern int FIVE_KING_ATTACKERS_WEIGHT;
extern int SIX_KING_ATTACKERS_WEIGHT;
extern int MANY_KING_ATTACKERS_WEIGHT;
