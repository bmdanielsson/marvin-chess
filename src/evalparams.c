...
int PASSED_PAWN_RANK2_MG = 2;
int PASSED_PAWN_RANK3_MG = 0;
int PASSED_PAWN_RANK4_MG = 0;
int PASSED_PAWN_RANK5_MG = 30;
int PASSED_PAWN_RANK6_MG = 48;
int PASSED_PAWN_RANK7_MG = 153;
int PASSED_PAWN_RANK2_EG = 0;
int PASSED_PAWN_RANK3_EG = 0;
int PASSED_PAWN_RANK4_EG = 43;
int PASSED_PAWN_RANK5_EG = 84;
int PASSED_PAWN_RANK6_EG = 97;
int PASSED_PAWN_RANK7_EG = 132;
...
int CANDIDATE_PASSED_PAWN_RANK2_MG = 0;
int CANDIDATE_PASSED_PAWN_RANK3_MG = 6;
int CANDIDATE_PASSED_PAWN_RANK4_MG = 10;
int CANDIDATE_PASSED_PAWN_RANK5_MG = 21;
int CANDIDATE_PASSED_PAWN_RANK6_MG = 87;
int CANDIDATE_PASSED_PAWN_RANK2_EG = 0;
int CANDIDATE_PASSED_PAWN_RANK3_EG = 6;
int CANDIDATE_PASSED_PAWN_RANK4_EG = 10;
int CANDIDATE_PASSED_PAWN_RANK5_EG = 19;
int CANDIDATE_PASSED_PAWN_RANK6_EG = 72;
int FRIENDLY_KING_PASSER_DIST = -11;
int OPPONENT_KING_PASSER_DIST = 14;
int BACKWARD_PAWN_MG = -15;
int BACKWARD_PAWN_EG = -2;
int FREE_PASSED_PAWN_MG = 136;
int FREE_PASSED_PAWN_EG = 0;
