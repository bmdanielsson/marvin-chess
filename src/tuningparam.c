...
struct param_decl parameter_declarations[NUM_PARAM_DECLARATIONS] = {
    ...
    {"knight_material_value_mg", 474, 474, 200, 400},
    {"bishop_material_value_mg", 475, 475, 200, 400},
    {"rook_material_value_mg", 476, 476, 400, 600},
    {"queen_material_value_mg", 477, 477, 700, 1400},
    {"knight_material_value_eg", 478, 478, 200, 400},
    {"bishop_material_value_eg", 479, 479, 200, 400},
    {"rook_material_value_eg", 480, 480, 400, 600},
    {"queen_material_value_eg", 481, 481, 700, 1400}
};
