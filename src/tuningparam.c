...
enum {
    ...
    TP_FIVE_KING_ATTACKERS_WEIGHT,
    TP_SIX_KING_ATTACKERS_WEIGHT,
...
struct param_decl parameter_declarations[NUM_PARAM_DECLARATIONS] = {
    ...
    {"five_king_attackers_weight", 820, 820, 0, 100},
    {"six_king_attackers_weight", 821, 821, 0, 100},
    {"many_king_attackers_weight", 822, 822, 0, 100}
};
...
void tuning_param_assign_current(struct tuning_param *params)
{
    ...
    ASSIGN(TP_FIVE_KING_ATTACKERS_WEIGHT, FIVE_KING_ATTACKERS_WEIGHT)
    ASSIGN(TP_SIX_KING_ATTACKERS_WEIGHT, SIX_KING_ATTACKERS_WEIGHT)
...
struct tuning_param* tuning_param_create_list(void)
{
    ...
    DEFINE(TP_FIVE_KING_ATTACKERS_WEIGHT, FIVE_KING_ATTACKERS_WEIGHT)
    DEFINE(TP_SIX_KING_ATTACKERS_WEIGHT, SIX_KING_ATTACKERS_WEIGHT)
