...
enum {
    ...
    TP_CANDIDATE_PASSED_PAWN_RANK2_MG,
    TP_CANDIDATE_PASSED_PAWN_RANK3_MG,
    TP_CANDIDATE_PASSED_PAWN_RANK4_MG,
    TP_CANDIDATE_PASSED_PAWN_RANK5_MG,
    TP_CANDIDATE_PASSED_PAWN_RANK6_MG,
    TP_CANDIDATE_PASSED_PAWN_RANK2_EG,
    TP_CANDIDATE_PASSED_PAWN_RANK3_EG,
