...
#define MAX_HIDDEN_WEIGHT   MAX_QUANTIZED_ACTIVATION/HIDDEN_WEIGHT_SCALE
#define MAX_OUTPUT_WEIGHT   MAX_QUANTIZED_ACTIVATION/OUTPUT_WEIGHT_SCALE
...
{
    v = CLAMP(v, -1*MAX_HIDDEN_WEIGHT, MAX_HIDDEN_WEIGHT);
...
{
    v = CLAMP(v, -1*MAX_OUTPUT_WEIGHT, MAX_OUTPUT_WEIGHT);
